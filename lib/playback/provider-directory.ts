...
export const PROVIDER_DIRECTORY: Record<string, ProviderDirectoryEntry> = {
  ...
  upstream: {
    ...
    name: "UpStream",
    category: "VIDEO_HOST",
    referenceUrl: "https://upstream.to",
    docsUrl: "https://upstream.to/api",
    officialDomain: "https://upstream.to",
    integrationType: "IFRAME_EMBED",
    authType: "API_KEY",
    envFlag: "UPSTREAM_ENABLED",
    defaultPriority: 11,
    description: "High-speed cloud video hosting and streaming service with embeddable player.",
    capabilities: {
      supportsMovie: true,
      supportsTV: true,
      supportsEpisode: true,
  ...
  mixdrop: {
    ...
    name: "MixDrop",
    category: "VIDEO_HOST",
    referenceUrl: "https://mixdrop.ag",
    docsUrl: "https://mixdrop.ag/api",
    officialDomain: "https://mixdrop.ag",
    integrationType: "IFRAME_EMBED",
    authType: "API_KEY",
    envFlag: "MIXDROP_ENABLED",
    defaultPriority: 12,
    description: "Fast cloud video storage provider with instant streaming embed.",
    capabilities: {
      supportsMovie: true,
      supportsTV: true,
      supportsEpisode: true,
  ...
  doodstream: {
    ...
    name: "DoodStream",
    category: "VIDEO_HOST",
    referenceUrl: "https://doodstream.com",
    docsUrl: "https://doodapi.com",
    officialDomain: "https://doodstream.com",
    integrationType: "IFRAME_EMBED",
    authType: "API_KEY",
    envFlag: "DOODSTREAM_ENABLED",
    defaultPriority: 13,
    description: "Distributed video streaming network with embed player support.",
    capabilities: {
      supportsMovie: true,
      supportsTV: true,
      supportsEpisode: true,
  ...
  vidoza: {
    ...
    name: "Vidoza",
    category: "VIDEO_HOST",
    referenceUrl: "https://vidoza.net",
    docsUrl: "https://api.vidoza.net/v1",
    officialDomain: "https://vidoza.net",
    integrationType: "IFRAME_EMBED",
    authType: "API_KEY",
    envFlag: "VIDOZA_ENABLED",
    defaultPriority: 14,
    description: "High-performance video hosting platform with HTML5 embed player.",
    capabilities: {
      supportsMovie: true,
      supportsTV: true,
      supportsEpisode: true,
